...
const SocialMediaBar = () => (
  <div className="text-center p-0 socialMediaBar">
    <Container>
      <Row>
        <Col lg={{ span: 4, offset: 8 }} className="my-2 w-100">
          <a href="https://facebook.com/">
            <span className="socialMediaBar__logo socialMediaBar__logo--facebook">
          ...
          <a href="https://twitter.com/">
            <span className="socialMediaBar__logo socialMediaBar__logo--twitter">
          ...
          <a href="https://youtube.com/">
            <span className="socialMediaBar__logo socialMediaBar__logo--youtube">
          ...
          <a href="https://twitch.tv/">
            <span className="socialMediaBar__logo socialMediaBar__logo--twitch">
